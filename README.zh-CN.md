...
**发布状态：** `v0.1.0-rc.3` 是带有 QEMU 证据的预发布版本。它修复了 rc.1 和 rc.2 在 Windows
...
1. 从最新 GitHub Release 下载通用镜像：
   ...
   `nextboot-v0.1.0-rc.3-universal-uefi.img.zip` 并解压。
...
最新发布：<https://github.com/tianrking/NextBoot/releases/tag/v0.1.0-rc.3>
