...
**发布状态：** `v0.1.0-rc.9` 是预发布版本。它增加了 Windows 原生挂载与写入/读回检查，并附带
...
1. 从最新 GitHub Release 下载通用镜像：
   ...
   `nextboot-v0.1.0-rc.9-universal-uefi.img.zip` 并解压。
2. Windows 下请下载 `nextboot-v0.1.0-rc.9-windows-writer.ps1`，以**管理员身份**打开
...
最新发布：<https://github.com/tianrking/NextBoot/releases/tag/v0.1.0-rc.9>
