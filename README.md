...
**Release status:** `v0.1.0-rc.4` is a QEMU-evidence prerelease. It repairs
...
1. Download the universal image from the latest GitHub release:
   ...
   `nextboot-v0.1.0-rc.4-universal-uefi.img.zip` and extract it.
...
Latest release: <https://github.com/tianrking/NextBoot/releases/tag/v0.1.0-rc.4>
