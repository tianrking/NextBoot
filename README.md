...
```bash
# 轻量项目健康检查：500 行限制、Python 编译、shell 语法、host 单测、flash/QEMU/硬件门禁和 UEFI check
...
virtio、SATA/NTFS、NVMe/UDF、NVMe/ext3、NVMe/XFS、NVMe 512B/XFS、NVMe/XFS VLNK、NVMe raw IMG、NVMe fixed/dynamic VHD、NVMe VHDX、NVMe sparse/partially-present VHDX、NVMe dynamic/static/sparse/discarded VDI 和 NVMe/ext4 Linux 插件载荷。SD 目前限制为 512B 扇区，因为 QEMU `sd-card` 设备没有提供和
