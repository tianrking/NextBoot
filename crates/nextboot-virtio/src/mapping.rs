...
pub use byte::{ByteMapping, ByteMappingTable};
...
impl MappingTable {
    ...
    /// 批量转换
    pub fn translate_range(&self, virtual_start: u64, count: u64) -> Option<Vec<(u64, u64)>> {
...
mod tests {
    ...
    #[test]
    fn test_optimize() {
        let mut table = MappingTable::with_segments(&[(0, 50, 1000), (50, 50, 1050)]);
