use crate::media_grow_util::{
    crc32, device_path_to_vec, div_round_up, read_le_u32, read_le_u64, update_exfat_boot_checksum,
    write_le_u32, write_le_u64, zeroed_vec,
};
...
fn update_exfat_boot(
    ...
    update_exfat_allocation_bitmap_length(
        block_io,
        media_id,
        block_size,
        data,
        &boot,
        growth.cluster_count,
    )?;
...
fn update_exfat_allocation_bitmap_length(
    block_io: &mut BlockIO,
    media_id: u32,
    block_size: u32,
    data: PartitionInfo,
