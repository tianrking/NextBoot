use super::block_io::UefiBlockIo;
use super::helpers::offset_extents_for_physical_read;
use super::model::{ImageFormat, IsoExtent, ResolvedImageMetadata, VolumeBlockInfo};
