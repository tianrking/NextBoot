...
CASES = (
    ...
    ImageCase(
        ...
        (
            ...
            f"nextboot-smoke-{ARCH_TAG}-parent-level-3.vhdbase",
            f"nextboot-smoke-{ARCH_TAG}-parent-level-4.vhdbase",
            "verified 5 /ISO image file(s)",
        ),
        f"nextboot-smoke-{ARCH_TAG}-parent-chain.vhdx",
    ),
    ImageCase(
        "NVMe 4K split missing-parent VHDX",
        (
            "--bus",
            "nvme",
            "--layout",
    ...
    ImageCase(
        ...
        (
            ...
            f"nextboot-smoke-{ARCH_TAG}-parent-level-3.vdibase",
            f"nextboot-smoke-{ARCH_TAG}-parent-level-4.vdibase",
            "verified 5 /ISO image file(s)",
        ),
        f"nextboot-smoke-{ARCH_TAG}-parent-chain.vdi",
    ),
    ImageCase(
        "NVMe 4K split missing-parent VDI",
        (
            "--bus",
            "nvme",
            "--layout",
