...
This checker validates the GPT layout and the small FAT32/exFAT/ext4/NTFS/UDF volumes
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--data-fs", default="exfat", choices=("exfat", "ext4", "fat32", "ntfs", "udf"))
