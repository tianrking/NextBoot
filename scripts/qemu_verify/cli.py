...
This checker validates the GPT layout and the small FAT32/exFAT/ext2/3/4/NTFS/UDF volumes
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--data-fs", default="exfat", choices=("exfat", "ext2", "ext3", "ext4", "fat32", "ntfs", "udf"))
