...
This checker validates the GPT layout and the small FAT32/exFAT/NTFS/UDF volumes
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--data-fs", default="exfat", choices=("exfat", "fat32", "ntfs", "udf"))
