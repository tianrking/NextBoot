...
Options:
  ...
  --smoke-missing-parent-vhdx
                     Generate a parent-backed VHDX without its parent and verify diagnostics
...
Examples:
  ...
  $0 --bus nvme --layout split --data-fs exfat --sector-size 4096 --smoke-missing-parent-vhdx
